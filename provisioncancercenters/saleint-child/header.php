...
<!-- Retargeting Code  -->
<!-- DO NOT MODIFY - added per LocalX on 1/120/2017-->
<script async src="https://i.simpli.fi/dpx.js?cid=50025&action=100&segment=LocalXProvisionPCCCSiteRetargeting&m=1&sifi_tuid=44537"></script>
<!-- DO NOT MODIFY -->
...
<?php if(!empty($options['theme-skin']) && $options['theme-skin'] == 'ascend' || $headerFormat == 'left-header' ) { get_template_part('includes/header-search'); } ?> 
